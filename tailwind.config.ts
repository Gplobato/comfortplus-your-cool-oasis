  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        violet: { soft: "hsl(var(--violet-soft))", "soft-foreground": "hsl(var(--violet-soft-foreground))" },
        blue: { soft: "hsl(var(--blue-soft))", "soft-foreground": "hsl(var(--blue-soft-foreground))" },
        sidebar: {
